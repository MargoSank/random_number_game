import classes from "./ResponseHistory.module.css";
import ButtonNumber from "../../common_components/ButtonNumber";

export const ResponseHistory = (props) => {

    const headerInstruction = <h4 className={classes.header}>After entering the number, press enter button to submit</h4>
